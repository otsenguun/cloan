...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        ...
                        <img class="main_logo" src="{{asset('images/dan_logo.png')}}" alt="">
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ url('/wallet') }}">
                       Хэтэвч
                    </x-jet-nav-link>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ url('/handbook') }}">
                       Ашиглах заавар
                    </x-jet-nav-link>
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-jet-responsive-nav-link href="{{ url('/help') }}">
                {{ __('messages.Brand') }}
            </x-jet-responsive-nav-link>
        ...
        @else 
            ...
            <x-jet-responsive-nav-link href="{{ url('login') }}">
                <a href="{{url('login')}}">Нэвтрэх</a>
            </x-jet-responsive-nav-link>
        @endif
